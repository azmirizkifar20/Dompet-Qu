...
// koneksi ke databse
include 'ajax/updatePemasukkan.php';
...
$pemasukkan = query("SELECT * FROM masuk WHERE tanggal = '$today'");
            ...
            <script type="text/javascript" src="js/pisahTitik.js"></script>
                ...
                <div class="form-group">
                    <label>Masukkan Sumber Pemasukkan</label>
                        <select name="sumber" class="form-control" id="exampleFormControlSelect1">
                            <option>ATM</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="userId" class="form-control">
                        ...
                        <div class="form-group">
                            <label for="harga">Jumlah Pemasukkan</label>
